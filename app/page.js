...
export default function Home() {
  ...
  const desiItems = [
    ...
    { img:"malai boti.jpg",  name:"Chicken Malai Boti", price:15.99, desc:"Creamy grilled chicken with mild spices." },
    { img:"butter chicken.jpg", name:"Butter Chicken", price:14.99, desc:"Chicken in rich buttery tomato cream sauce." },
    { img:"tikka.jpg",       name:"Chicken Tikka",    price:13.99, desc:"Charcoal grilled tikka in yogurt marinade." },
