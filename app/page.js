...
const getCalzoneExtraCount = (name, tops) => Math.max(0, tops.length - (calzoneFreeToppings[name] || 0));
  ...
  { img:"bosco.jpg", name:"Bosco Breadsticks", price:7.99, desc:"Breadsticks stuffed with mozzarella cheese, topped with garlic butter & parmesan, served with a side of marinara.", sizes:[{ label:"4 pcs", price:7.99 }, { label:"8 pcs", price:10.99 }] },
